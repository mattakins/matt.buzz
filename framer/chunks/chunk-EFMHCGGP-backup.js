        ...
        _jsx("div", {
          ...
          children: _jsxs("div", {
            ...
            children: [
              // About tile
              _jsx("div", {
                className: "grid-tile about-tile unified-bg-tile",
                style: {
                  position: "relative",
                  background: "rgba(0, 0, 0, 0.3)",
                  backgroundImage: "url(https://framerusercontent.com/images/WkhfKz1YJ2Y3ADVaM.jpg)",
              ...
              // Portfolio tile
              _jsx("div", {
                className: "grid-tile portfolio-tile unified-bg-tile",
                style: {
                  position: "relative",
                  background: "rgba(0, 0, 0, 0.3)",
                  backgroundImage: "url(https://framerusercontent.com/images/WkhfKz1YJ2Y3ADVaM.jpg)",
              ...
              _jsx("div", {
                className: "grid-tile contact-tile unified-bg-tile",
                style: {
                  position: "relative",
                  background: "rgba(0, 0, 0, 0.3)",
                  backgroundImage: "url(https://framerusercontent.com/images/WkhfKz1YJ2Y3ADVaM.jpg)",
              ...
              // Stack tile
              _jsx("div", {
                className: "grid-tile stack-tile unified-bg-tile",
                style: {
                  position: "relative",
                  background: "rgba(0, 0, 0, 0.3)",
                  backgroundImage: "url(https://framerusercontent.com/images/WkhfKz1YJ2Y3ADVaM.jpg)",
