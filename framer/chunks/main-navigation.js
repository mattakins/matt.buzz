...
// ============================================================================
// CLEAN NAVIGATION COMPONENT WITH THEME SWITCHER
// ============================================================================
// This is a rewritten version of chunk-CB5YAPNW.js with clean, readable structure
...
import {
  ...
  usePrefetch as usePrefetch2,
  usePreloadQuery as usePreloadQuery2,
...
// ============================================================================
// Custom theme management system for light/dark mode switching
import { jsx as _jsx } from "react/jsx-runtime";
import { useEffect as useEffect2 } from "react";
import { useState, useEffect } from "react";
import { Data, useObserveData } from "unframer";

// Store creation for theme state management
...
// Higher-order component for theme toggle functionality
function withSingleToggle(Component5) {
  return (props) => {
    ...
    useEffect2(() => {
      ...
      // Extract and apply CSS theme tokens
            ...
            if (rule.selectorText === ":root") {
              ...
              for (let j = 0; j < style.length; j++) {
                ...
                if (propertyName.includes("--token")) {
                  const value = style.getPropertyValue(propertyName);
                  const combinedCssRule = `${propertyName}: ${value};`;
                  darkThemeTokens.push(combinedCssRule);
                }
              }
            }
          }
      ...
      darkThemeTokens = darkThemeTokens.join(" ");
    ...
    return /* @__PURE__ */ _jsx(Component5, { ...props, onClick: handleClick });
  };
}
...
// Props getter for theme component
var getProps = ({ height, id, variant1, width, ...props }) => {
  return {
    ...props,
    WWUpHWDUE: humanReadableEnumMap[variant1] ?? variant1 ?? props.WWUpHWDUE ?? "TzgVzetvp"
  };
};

// Layout dependency creator
    ...
    children: /* @__PURE__ */ _jsx2(Variants, {
      ...
      children: /* @__PURE__ */ _jsx2(Transition, {
        ...
        children: /* @__PURE__ */ _jsx2(motion.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx(scopingClassNames, "framer-1wvnutb", className3, classNames),
          ...
          children: /* @__PURE__ */ _jsx2(ComponentViewportProvider, {
            height: 14,
            y: (componentViewport?.y || 0) + (0 + ((componentViewport?.height || 28) - 0 - 14) / 2),
...
// Theme component CSS and exports
var css3 = [
  ...
  "exports": {
    ...
    "default": {
      ...
      "annotations": {
        ...
        "framerVariables": '{"WWUpHWDUE":"variant1"}',
...
var Component2 = /* @__PURE__ */ React2.forwardRef(function(props, ref) {
  ...
  // Display logic for responsive behavior
  const isDisplayed = () => {
    ...
    children: /* @__PURE__ */ _jsx3(Variants2, {
      ...
      children: /* @__PURE__ */ _jsx3(Transition2, {
        ...
        children: /* @__PURE__ */ _jsx3(Link, {
          ...
          scopeId: "GgrtPuQqi",
          smoothScroll: true,
          children: /* @__PURE__ */ _jsx3(motion2.a, {
            ...restProps,
            ...gestureHandlers,
            className: `${cx2(scopingClassNames, "framer-1fxl2nl", className3, classNames)} framer-18q79sz`,
            ...
            ...addPropertyOverrides({
              "Brw2_DrkB-hover": { "data-framer-name": void 0 },
              yncl8rBTV: { "data-framer-name": "Phone" }
            ...
            children: /* @__PURE__ */ _jsxs(motion2.div, {
              ...
              layoutId: "ktt8iRWXB",
              children: [
                // Top text element with animation
                /* @__PURE__ */ _jsxs(motion2.div, {
                  ...
                  layoutId: "pxfcezWgp",
                  style: { skewY: 0 },
                  variants: { "Brw2_DrkB-hover": { skewY: 12 } },
                  children: [
                    // Back icon (optional)
                    rBHQvKcR2 && /* @__PURE__ */ _jsx3(motion2.div, {
                      ...
                      children: /* @__PURE__ */ _jsx3(SVG, {
                        ...
                        layoutId: "qkjpHHwu_",
                        opacity: 1,
                        svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 14 12"><path d="M 0.702 5.653 L 11.484 5.653 L 6.863 1.032 L 7.444 0.372 L 13.165 6.093 L 7.444 11.813 L 6.863 11.153 L 11.484 6.533 L 0.702 6.533 Z" fill="var(--token-5fde730a-8086-4528-a317-d71b3bf4efde, rgb(255, 255, 255))"></path></svg>',
                        svgContentId: 12663815606,
                        withExternalLayout: true,
                        ...addPropertyOverrides({
                          yncl8rBTV: {
                            svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 13 11"><path d="M 0.652 5.181 L 10.664 5.181 L 6.373 0.946 L 6.912 0.341 L 12.225 5.585 L 6.912 10.829 L 6.373 10.224 L 10.664 5.988 L 0.652 5.988 Z" fill="var(--token-5fde730a-8086-4528-a317-d71b3bf4efde, rgb(255, 255, 255))"></path></svg>',
                    ...
                    /* @__PURE__ */ _jsx3(RichText, {
                      ...
                      children: /* @__PURE__ */ _jsx3(React2.Fragment, {
                        children: /* @__PURE__ */ _jsx3(motion2.p, {
                          ...
                          style: { "--framer-text-color": "var(--extracted-r6o4lv, var(--token-5fde730a-8086-4528-a317-d71b3bf4efde, rgb(255, 255, 255)))" },
                          children: "Name"
                        })
                      }),
                ...
                // Bottom text element (hidden on phone)
                isDisplayed() && /* @__PURE__ */ _jsxs(motion2.div, {
                  ...
                  layoutId: "LQJEZqzXq",
                  style: { skewY: 12 },
                  variants: { "Brw2_DrkB-hover": { skewY: 0 } },
                  children: [
                    // Back icon (optional)
                    rBHQvKcR2 && /* @__PURE__ */ _jsx3(motion2.div, {
                      ...
                      children: /* @__PURE__ */ _jsx3(SVG, {
                        ...
                        layoutId: "Px9oEybxE",
                        opacity: 1,
                        svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 12 12"><path d="M 0.227 5.681 L 10.11 5.681 L 5.875 1.446 L 6.407 0.841 L 11.651 6.085 L 6.407 11.329 L 5.875 10.724 L 10.11 6.488 L 0.227 6.488 Z" fill="var(--token-5fde730a-8086-4528-a317-d71b3bf4efde, rgb(255, 255, 255))"></path></svg>',
                        svgContentId: 10728380097,
                        withExternalLayout: true
                      })
                    }),
                    // Duplicate text content for animation effect
                    /* @__PURE__ */ _jsx3(RichText, {
                      __fromCanvasComponent: true,
                      children: /* @__PURE__ */ _jsx3(React2.Fragment, {
                        children: /* @__PURE__ */ _jsx3(motion2.p, {
...
// Logo component CSS and exports
var css4 = [
  "@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }",
...
addPropertyControls2(FramerGgrtPuQqi, {
  variant: {
...
// ============================================================================
// POSITION + TIME COMPONENT DEFINITION
// ============================================================================
...
// Position + Time component configuration
...
// Property overrides utility for Position + Time
...
// API query for location data
var query = (prefetch) => prefetch({
  cacheDuration: 86400,
...
// Transition wrapper for Position + Time
...
// Props getter for Position + Time component
var getProps3 = ({ height, id, position, width, ...props }) => {
  return {
    ...props,
    cmS0KoqX2: position ?? props.cmS0KoqX2 ?? "Design & Art Director",
    variant: humanReadableVariantMap2[props.variant] ?? props.variant ?? "FdPp7SphX"
  };
};

// Layout dependency creator for Position + Time
var createLayoutDependency3 = (props, variants) => {
  if (props.layoutDependency) return variants.join("-") + props.layoutDependency;
  return variants.join("-");
};

// Position + Time component implementation
    ...
    children: /* @__PURE__ */ _jsx4(Variants3, {
      ...
      children: /* @__PURE__ */ _jsx4(Transition3, {
        ...
        children: /* @__PURE__ */ _jsx4(motion3.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx3(scopingClassNames, "framer-9udc9x", className3, classNames),
          ...
          ...addPropertyOverrides2({
            WQvTZXkLI: { "data-framer-name": "Time" }
          }, baseVariant, gestureVariant),
          children: /* @__PURE__ */ _jsxs2(motion3.div, {
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxs2(motion3.div, {
                ...
                layoutId: "nbAW8irTM",
                style: { skewY: 12 },
                variants: { WQvTZXkLI: { skewY: 0 } },
                children: [
                  // Location fetcher
                  /* @__PURE__ */ _jsx4(Fetcher, {
                    disabled: isLoading,
                    requests: [{
                      cacheDuration: 86400,
                      credentials: "same-origin",
                    ...
                    children: (fetchResult) => /* @__PURE__ */ _jsx4(RichText2, {
                      __fromCanvasComponent: true,
                      children: /* @__PURE__ */ _jsx4(React3.Fragment, {
                        children: /* @__PURE__ */ _jsx4(motion3.p, {
                          className: "framer-styles-preset-1heszc",
                  ...
                  /* @__PURE__ */ _jsx4(ComponentViewportProvider2, {
                    children: /* @__PURE__ */ _jsx4(SmartComponentScopedContainer2, {
                      ...
                      rendersWithMotion: true,
                      scopeId: "yO1RGvvnp",
                      children: /* @__PURE__ */ _jsx4(Time, {
                        color: "var(--token-5fde730a-8086-4528-a317-d71b3bf4efde, rgb(255, 255, 255))",
                        font: {
...
// Position + Time component CSS and exports
var css5 = [
  "@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }",
...
addPropertyControls3(FrameryO1RGvvnp, {
  variant: {
...
}, ...TimeDateFonts, ...getFontsFromSharedStyle2(fonts2)], { supportsExplicitInterCodegen: true });

// ============================================================================
// MAIN NAVIGATION COMPONENT DEFINITION
// ============================================================================
// Font and component imports for main nav
...
// Enhanced theme component with single toggle
var ThemeWithSingleToggle1pv7arxWithMappedReactProps1ag0w6l = withMappedReactProps(
...
var variantClassNames4 = {
  NktlPJpSy: "framer-v-1fav3p8",
  nrfrLHug9: "framer-v-qokw3z",
  RSqCSoNz4: "framer-v-mfqu82"
};

// Property overrides utility for main nav
...
// Location API query for main nav
var query2 = (prefetch) => prefetch({
  cacheDuration: 0,
  credentials: "same-origin",
  errorFallbackValue: "Cairo",
  fallbackValue: "Cairo",
  resultKeyPath: "city",
  resultOutputType: "string",
  url: `https://api.fetch.tools/location`
...
// String conversion utility for main nav
var toString2 = (value) => {
  return typeof value === "string" ? value : String(value);
};

// Transition wrapper for main nav
...
// Loading variant management for main nav
...
// Props getter for main nav component
var getProps4 = ({ backIcon, height, id, link, name1, position, width, ...props }) => {
  return {
    ...props,
    cAtzncPer: name1 ?? props.cAtzncPer ?? "Name",
    MjfGjNDud: position ?? props.MjfGjNDud ?? "Design & Art Director",
    mO0CDvk_7: link ?? props.mO0CDvk_7,
    NFDjggJY2: backIcon ?? props.NFDjggJY2,
    variant: humanReadableVariantMap3[props.variant] ?? props.variant ?? "RSqCSoNz4"
  };
};

// Layout dependency creator for main nav
var createLayoutDependency4 = (props, variants) => {
  if (props.layoutDependency) return variants.join("-") + props.layoutDependency;
  return variants.join("-");
};

// Main navigation component implementation
  ...
  return /* @__PURE__ */ _jsx5(LayoutGroup4, {
    ...
    children: /* @__PURE__ */ _jsx5(Variants4, {
      ...
      children: /* @__PURE__ */ _jsx5(Transition4, {
        value: transition14,
        children: /* @__PURE__ */ _jsxs3(motion4.nav, {
          ...restProps,
          ...gestureHandlers,
          className: cx4(scopingClassNames, "framer-mfqu82", className3, classNames),
          "data-framer-name": "Desktop",
          layoutDependency,
          layoutId: "RSqCSoNz4",
          ref: refBinding,
          ...
          ...addPropertyOverrides3({
            NktlPJpSy: { "data-framer-name": "Phone" },
            nrfrLHug9: { "data-framer-name": "Tablet" }
          }, baseVariant, gestureVariant),
          children: [
            // Left section with logo and position
            /* @__PURE__ */ _jsxs3(motion4.div, {
              className: "framer-1fnd8",
              ...
              children: [
                ...
                /* @__PURE__ */ _jsx5(motion4.div, {
                  className: "framer-snsv5m",
                  "data-framer-name": "Logo",
                  layoutDependency,
                  layoutId: "mptoU9fGx",
                  children: /* @__PURE__ */ _jsx5(ComponentViewportProvider3, {
                    height: 23,
                    y: (componentViewport?.y || 0) + (24 + ((componentViewport?.height || 76) - 48 - 23) / 2) + 0 + 0,
                    ...addPropertyOverrides3({
                      NktlPJpSy: {
                        y: (componentViewport?.y || 0) + (16 + ((componentViewport?.height || 200) - 32 - 23) / 2) + 0 + 0
                      }
                    }, baseVariant, gestureVariant),
                    children: /* @__PURE__ */ _jsx5(SmartComponentScopedContainer3, {
                      className: "framer-299xz1-container",
                      layoutDependency,
                      layoutId: "NlBhTEWvZ-container",
                      nodeId: "NlBhTEWvZ",
                      rendersWithMotion: true,
                      scopeId: "rD0JqOcZx",
                      children: /* @__PURE__ */ _jsx5(stdin_default3, {
                        ...
                        z7WESOA3t: cAtzncPer,
                        ...addPropertyOverrides3({
                          NktlPJpSy: { variant: "yncl8rBTV" }
                        }, baseVariant, gestureVariant)
                      })
                    })
                  })
                }),
                // Position text (desktop/tablet only)
                isDisplayed() && /* @__PURE__ */ _jsx5(motion4.div, {
                  className: "framer-x2mr3q",
                  "data-framer-name": "Position",
                  layoutDependency,
                  layoutId: "lgMyz2LBh",
                  children: /* @__PURE__ */ _jsx5(RichText3, {
                    __fromCanvasComponent: true,
                ...
                // Position + Time component (phone only)
                isDisplayed1() && /* @__PURE__ */ _jsx5(ComponentViewportProvider3, {
                  ...addPropertyOverrides3({
                    NktlPJpSy: {
                      height: 20,
                      y: (componentViewport?.y || 0) + (16 + ((componentViewport?.height || 200) - 32 - 23) / 2) + 1.5
                    }
                  }, baseVariant, gestureVariant),
                  children: /* @__PURE__ */ _jsx5(SmartComponentScopedContainer3, {
                    className: "framer-190raj9-container",
                    layoutDependency,
                    layoutId: "GrwgHlytH-container",
                    nodeId: "GrwgHlytH",
                    rendersWithMotion: true,
                    scopeId: "rD0JqOcZx",
            ...
            // Right section with city/time and theme toggle
            /* @__PURE__ */ _jsxs3(motion4.div, {
              className: "framer-16d7p45",
              "data-framer-name": "Right",
              layoutDependency,
              layoutId: "ceA0y6jIt",
              children: [
                // City + Time section (desktop/tablet only)
                isDisplayed() && /* @__PURE__ */ _jsxs3(motion4.div, {
                  className: "framer-16lhqb",
                  "data-framer-name": "City + Time",
                  layoutDependency,
                  layoutId: "LMX1IFe94",
                  children: [
                    // Location fetcher
                    /* @__PURE__ */ _jsx5(Fetcher2, {
                      disabled: isLoading,
                      requests: [{
                        cacheDuration: 0,
                        credentials: "same-origin",
                      ...
                      children: (fetchResult) => /* @__PURE__ */ _jsx5(RichText3, {
                        __fromCanvasComponent: true,
                        children: /* @__PURE__ */ _jsx5(React4.Fragment, {
                          children: /* @__PURE__ */ _jsx5(motion4.p, {
                            className: "framer-styles-preset-158jz12",
                        ...
                        text: toString2(fetchResult[0]),
                        verticalAlignment: "top",
                        withExternalLayout: true
                      })
                    }),
                    // Separator dot
                    /* @__PURE__ */ _jsx5(RichText3, {
                      __fromCanvasComponent: true,
                      children: /* @__PURE__ */ _jsx5(React4.Fragment, {
                        children: /* @__PURE__ */ _jsx5(motion4.p, {
                          className: "framer-styles-preset-158jz12",
                    ...
                    /* @__PURE__ */ _jsx5(ComponentViewportProvider3, {
                      children: /* @__PURE__ */ _jsx5(SmartComponentScopedContainer3, {
                        ...
                        isModuleExternal: true,
                        layoutDependency,
                        layoutId: "nbydFev_g-container",
                        nodeId: "nbydFev_g",
                        rendersWithMotion: true,
                        scopeId: "rD0JqOcZx",
                        children: /* @__PURE__ */ _jsx5(Time, {
                          color: "var(--token-5fde730a-8086-4528-a317-d71b3bf4efde, rgb(255, 255, 255))",
                          font: {
                            fontFamily: '"Open Sauce Sans", "Open Sauce Sans Placeholder", sans-serif',
                            fontSize: "16px",
                ...
                /* @__PURE__ */ _jsx5(motion4.div, {
                  className: "framer-1oe55lg",
                  "data-framer-name": "Theme",
                  layoutDependency,
                  layoutId: "sZrPiCUde",
                  children: /* @__PURE__ */ _jsx5(ComponentViewportProvider3, {
                    height: 28,
                    y: (componentViewport?.y || 0) + (24 + ((componentViewport?.height || 76) - 48 - 28) / 2) + 0 + 0 + 0,
                    ...addPropertyOverrides3({
                      NktlPJpSy: {
                        y: (componentViewport?.y || 0) + (16 + ((componentViewport?.height || 200) - 32 - 28) / 2) + 0 + 0 + 0
                      }
                    }, baseVariant, gestureVariant),
                    children: /* @__PURE__ */ _jsx5(SmartComponentScopedContainer3, {
                      className: "framer-1pv7arx-container",
                      layoutDependency,
                      layoutId: "Tx1r9sZFg-container",
                      nodeId: "Tx1r9sZFg",
                      rendersWithMotion: true,
                      scopeId: "rD0JqOcZx",
                      children: /* @__PURE__ */ _jsx5(ThemeWithSingleToggle1pv7arxWithMappedReactProps1ag0w6l, {
                        height: "100%",
                        id: "Tx1r9sZFg",
                        layoutId: "Tx1r9sZFg",
                        width: "100%"
...
// ============================================================================
// MAIN NAVIGATION CSS AND EXPORTS
// ============================================================================
var css6 = [
  "@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }",
  ".framer-FnS0m.framer-12mgxwu, .framer-FnS0m .framer-12mgxwu { display: block; }",
  ".framer-FnS0m.framer-mfqu82 { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; height: min-content; justify-content: space-between; overflow: hidden; padding: 24px; position: relative; width: 1440px; }",
  ".framer-FnS0m .framer-1fnd8 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 120px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: min-content; z-index: 2; }",
  ".framer-FnS0m .framer-snsv5m { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: min-content; }",
  ".framer-FnS0m .framer-299xz1-container, .framer-FnS0m .framer-190raj9-container, .framer-FnS0m .framer-6w34di-container, .framer-FnS0m .framer-1pv7arx-container { flex: none; height: auto; position: relative; width: auto; }",
  ".framer-FnS0m .framer-x2mr3q { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 6px; height: min-content; justify-content: flex-end; overflow: visible; padding: 0px; position: relative; width: min-content; }",
  ".framer-FnS0m .framer-dj20t2, .framer-FnS0m .framer-1kiolsp, .framer-FnS0m .framer-9200ud { flex: none; height: auto; position: relative; white-space: pre; width: auto; }",
  ".framer-FnS0m .framer-16d7p45 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 100px; height: min-content; justify-content: flex-end; overflow: visible; padding: 0px; position: relative; width: min-content; z-index: 2; }",
  ".framer-FnS0m .framer-16lhqb { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 4px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: min-content; }",
  ".framer-FnS0m .framer-1oe55lg { align-content: flex-end; align-items: flex-end; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 32px; }",
  ".framer-FnS0m.framer-v-qokw3z.framer-mfqu82 { width: 700px; }",
  ".framer-FnS0m.framer-v-qokw3z .framer-1fnd8, .framer-FnS0m.framer-v-qokw3z .framer-16d7p45, .framer-FnS0m.framer-v-1fav3p8 .framer-16d7p45 { gap: 48px; }",
  ".framer-FnS0m.framer-v-1fav3p8.framer-mfqu82 { padding: 16px; width: 390px; }",
  ".framer-FnS0m.framer-v-1fav3p8 .framer-1fnd8 { gap: 32px; }",
  ".framer-FnS0m.framer-v-1fav3p8 .framer-snsv5m { cursor: pointer; }",
  ...css
];
...
addPropertyControls4(FramerrD0JqOcZx, {
  variant: {
    options: ["RSqCSoNz4", "nrfrLHug9", "NktlPJpSy"],
...
}, ...LogoFonts, ...PositionTimeFonts, ...TimeDateFonts2, ...ThemeFonts, ...getFontsFromSharedStyle3(fonts)], { supportsExplicitInterCodegen: true });
